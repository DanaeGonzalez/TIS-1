<?php
    include '../../mantenedores/conexion.php';
?>
    ...
    <?php
        ...
        if (isset($_REQUEST['correo'])){
            ...
            if (strlen($contrasenia) >= 8 && strlen($contrasenia) <= 15 && !preg_match('/\s/', $contrasenia)) {
                ...
                VALUES ('$nombre', '$apellido', '$run', '$correo', '$numero', '$contrasenia', 'Registrado', '0', '1')";
                ...
                echo "<div class='form'><h3>La contraseña debe tener entre 8 y 15 caracteres y no contener espacios.</h3></div>";
            }
        }
        else {
            ?>
            <div class="form">
                ...
                <form name="registro" action="" method="post"> 
                    ...
                    <input type="text" name="run" placeholder="123456789" required/>
                    <input type="number" name="numero" placeholder="+569" required/>
                    <input type="correo" name="correo" placeholder="micorreo@gmail.com" required/>
                    <input type="password" id="contrasenia" name="contrasenia" placeholder="Contraseña" required pattern=".{8,15}" title="8-15 caracteres sin espacios"/>
                    <button type="button" onclick="mostrar_ocultar()">Mostrar/Ocultar</button>
