        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav ms-auto align-items-center text-center">
                ...
                <li class="nav-item d-flex align-items-center gap-3">
                    ...
                    <!-- Botón de catálogo -->
                    <a href="/xampp/TIS-1/IKAT/views/catalogo.php" class="btn btn-link d-none d-lg-flex p-0">
                        <i class="bi bi-bag fs-4 text-secondary"></i>
                    </a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <?php if (isset($_SESSION['tipo_usuario'])) {
                            if ($_SESSION['tipo_usuario'] === 'Superadmin') { ?>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item" href="/xampp/TIS-1/IKAT/views/menu_registro/logout.php">Cerrar Sesión</a></li>
                                  </ul>
                        ...
                        <?php } else { ?>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="/xampp/TIS-1/IKAT/views/menu_registro/registro.php">Registrarse</a></li>
                                <li><a class="dropdown-item" href="/xampp/TIS-1/IKAT/views/menu_registro/login.php">Iniciar sesión</a></li>
                            </ul>
                        <?php } ?>
                    </div>
                </li>
