...
<body>
    ...
    <div class="d-flex">
      ...
      <div class="content-area flex-grow-1 p-5">
        <h1 class="text-center p-4">Editar Producto</h1>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="actualizar_producto.php" method="post">
                        ...
                        Descripción: <textarea class="form-control" required name="descripcion_producto"><?php echo $row['descripcion_producto']; ?></textarea><br>

                        Características: <textarea class="form-control" required name="caracteristicas_producto"><?php echo $row['caracteristicas_producto']; ?></textarea><br>

                        Foto del Producto (URL): <input class="form-control" required type="text" name="foto_producto" value="<?php echo $row['foto_producto']; ?>"><br>
