...
<head>
    ...
    <title>Editar Oferta - IKAT</title>
...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="content-area flex-grow-1 p-5">
            <h1 class="text-center p-4">Editar Oferta</h1>
            ...
            <form action="actualizar_oferta.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="idProducto" class="form-control" value="<?php echo $oferta['id_producto']; ?>" disabled>
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" min="0" max="1" id="porcentajeDescuento" 
                           ...
                           value="<?php echo $oferta['porcentaje_descuento']; ?>" required>
                </div>
