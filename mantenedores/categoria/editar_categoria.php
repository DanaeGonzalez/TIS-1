    ...
    <div class="container border mt-5" style="font-family: 'Newsreader', serif;">
        <div class="row">
            <div class="col-lg-6 p-5">
                ...
                <h1 class="text-center pb-4">Editar Categoría</h1>

                <form action="actualizar_categoria.php" method="post">
                    <input type="hidden" name="id_categoria" value="<?php echo $row['id_categoria']; ?>">
                    Nombre: <input type="text" class="form-control" required name="nombre_categoria" value="<?php echo $row['nombre_categoria']; ?>"><br><br>
