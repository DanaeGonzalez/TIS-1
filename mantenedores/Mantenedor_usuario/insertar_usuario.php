        ...
        <div class="row">
            <div class="col-lg-6 p-5">
                ...
                <form action="insertar_usuario.php" method="post">
                    Nombre: <input class="form-control" type="text" name="nombre_usuario" required><br>

                    Apellido: <input class="form-control" type="text" name="apellido_usuario" required><br>

                    RUN: <input class="form-control" type="text" name="run_usuario" required><br>

                    Correo: <input class="form-control" type="email" name="correo_usuario" required><br>

                    Teléfono: <input class="form-control" type="text" name="numero_usuario" required><br>

                    Contraseña: <input class="form-control" type="password" name="contrasenia_usuario" required><br>

                    Dirección: <input class="form-control" type="text" name="direccion_usuario" required><br>
