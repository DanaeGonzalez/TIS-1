            ...
            <div class="row">
                <div class="col-12 p-4 d-flex flex-column justify-content-center align-items-center">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if ($stmt->execute()) {
                            echo "Oferta actualizada exitosamente <br>";
                            echo "<a href='mostrar_ofertas.php' class='btn btn-primary mt-3'>Volver</a>";
                        } else {
                            echo "<div class='alert alert-danger'>Error al actualizar la oferta.</div>";
                            echo "<a href='mostrar_ofertas.php' class='btn btn-primary mt-3'>Volver</a>";
                        }
                    }
                    ?>
